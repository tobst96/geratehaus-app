...
async def zwei_faktor_status(ich: CurrentGruppenfuehrer) -> ZweiFaktorStatus:
...
async def zwei_faktor_aktivieren(db: DbSession, ich: CurrentGruppenfuehrer) -> RecoveryCodesOut:
...
async def recovery_codes_neu(db: DbSession, ich: CurrentGruppenfuehrer) -> RecoveryCodesOut:
