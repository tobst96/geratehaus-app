...
async def oeffentliche_konfiguration(db: DbSession) -> OeffentlicheKonfiguration:
    ...
    return OeffentlicheKonfiguration(
        ...
        impressum_verantwortliche_person=werte.get("impressum_verantwortliche_person", ""),
        impressum_anschrift=werte.get("impressum_anschrift", ""),
        impressum_email=werte.get("impressum_email", ""),
        impressum_telefon=werte.get("impressum_telefon", ""),
        impressum_zusatz=werte.get("impressum_zusatz", ""),
