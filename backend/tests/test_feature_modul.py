...
async def test_liste_default_reihenfolge_und_immer_aktiv(db):
    ...
    for key in ("personal", "fahrzeuge", "benachrichtigungen", "kiosk", "backup"):
...
async def test_reihenfolge_setzen_und_validierung(db):
    neu = ["divera", "pressebericht", "barcode", "personal", "fahrzeuge", "benachrichtigungen", "kiosk", "backup", "minio", "einsatztagebuch", "dienstbuch", "dienststunden", "fahrzeugbuchung", "formular"]
