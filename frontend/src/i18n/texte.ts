...
export const texte = {
  ...
  personal: {
    ...
    fehler_benachrichtigung_speichern: "Benachrichtigungen konnten nicht aktiviert werden.",
    ...
    ph_email_optional: "E-Mail (optional)",
    ph_pin_optional: "PIN (optional, 4-6 Ziffern)",
    weitere_angaben_zeigen: "+ Weitere Angaben (E-Mail, PIN, Benachrichtigungen)",
    weitere_angaben_verbergen: "− Weitere Angaben ausblenden",
    barcode_alt: "Barcode",
    abbrechen: "Abbrechen",
    anlegen: "Anlegen",
  ...
  dienstbuch_planer: {
    zurueck: "← Zurück zu den Modulen",
    titel: "Dienstbuch Planer",
    kategorien_titel: "Kategorien",
    kategorien_hinweis:
      "Farbige Kategorien für Planer-Termine (z. B. um die Belastung bestimmter Funktionen sichtbar " +
      "zu machen). Ein Termin kann mehrere Kategorien haben.",
    kategorie_name_platzhalter: "Neue Kategorie, z. B. Ausbildung",
    anlegen: "Anlegen",
    aktiv: "Aktiv",
    reihenfolge: "Reihenfolge",
    loeschen: "Löschen",
    vorlagen_titel: "Wiederholungsregeln (Vorlagen)",
    vorlagen_hinweis:
      "Wiederkehrende Termine (z. B. „Unterweisung UVV, immer KW 5, Mittwoch, ungerade Woche“). " +
      "Aus jeder aktiven Vorlage werden pro Jahr automatisch konkrete Termine berechnet.",
    feld_titel: "Titel",
    feld_wiederholungstyp: "Wiederholung",
    feld_intervall: "Alle wie viele Einheiten (X)",
    feld_wochentag: "Wochentag",
    feld_wochentag_beliebig: "– beliebig –",
    feld_kalenderwoche: "Kalenderwoche (1–53)",
    feld_kw_paritaet: "Kalenderwochen-Parität",
    feld_kw_paritaet_keine: "– keine Einschränkung –",
    feld_kw_paritaet_gerade: "gerade",
    feld_kw_paritaet_ungerade: "ungerade",
    feld_startdatum: "Gültig ab",
    feld_enddatum: "Gültig bis (optional)",
    feld_mindest_intervall_aktiv: "Mindest-Intervall (überfällig-Markierung)",
    feld_mindest_intervall_tage: "Mindestens alle X Tage",
    feld_kategorien: "Kategorien",
    wiederholungstyp_jaehrlich: "Jedes Jahr",
    wiederholungstyp_monatlich: "Jeden Monat",
    wiederholungstyp_alle_x_tage: "Alle X Tage",
    wiederholungstyp_alle_x_wochen: "Alle X Wochen",
    wiederholungstyp_alle_x_monate: "Alle X Monate",
    wiederholungstyp_alle_x_jahre: "Alle X Jahre",
    wochentag_0: "Montag",
    wochentag_1: "Dienstag",
    wochentag_2: "Mittwoch",
    wochentag_3: "Donnerstag",
    wochentag_4: "Freitag",
    wochentag_5: "Samstag",
    wochentag_6: "Sonntag",
    deaktivieren: "Deaktivieren",
    deaktiviert_badge: "inaktiv",
    fehler_laden: "Daten konnten nicht geladen werden.",
    fehler_speichern: "Speichern fehlgeschlagen.",
  },
} as const;
