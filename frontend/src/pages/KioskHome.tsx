  ...
  einsatzbericht: {
    ...
    icon: (
      <svg className="kiosk-tile-icon" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M32 16v14M25 23l14 14" stroke="#ffa633" strokeWidth="3" strokeLinecap="round" />
      </svg>
    ),
  },
  dienstbuch: {
    ...
    icon: (
      <svg className="kiosk-tile-icon" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M32 8v48" stroke="#ffa633" strokeWidth="2" />
        <path d="M16 18h10M16 26h10M16 34h10" stroke="#ffa633" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M38 18h10M38 26h10M38 34h10" stroke="#ffa633" strokeWidth="2.5" strokeLinecap="round" opacity="0.85" />
      </svg>
    ),
  },
  dienststunden: {
    ...
    icon: (
      <svg className="kiosk-tile-icon" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M32 18v16l11 7" stroke="#ffa633" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
};
  ...
  return (
    <div className="kiosk-container">
      ...
      <svg className="kiosk-wave" viewBox="0 0 1440 140" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0,80 C360,160 1080,0 1440,80 L1440,140 L0,140 Z" fill="#ffa633" />
      </svg>
    </div>
  );
}
